...
export const START_RESEND_EMAIL_CODE_SUCCESS = 'POST_EMAIL_SERVICES_EMAILS_RESEND_CODE_SUCCESS'
export const START_RESEND_EMAIL_CODE_FAIL = 'POST_EMAIL_SERVICES_EMAILS_RESEND_CODE_FAIL'
