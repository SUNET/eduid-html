...
export const VERIFY_LETTER_CODE = 'VERIFY_LETTER_CODE';
export const VERIFY_LETTER_CODE_FAIL = 'VERIFY_LETTER_CODE_FAIL';
export const VERIFY_LETTER_CODE_SUCCESS = 'VERIFY_LETTER_CODE_SUCCESS';
