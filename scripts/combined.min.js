...
},C.touch=function(){var c;return"ontouchstart"in a||a.DocumentTouch&&b instanceof DocumentTouch?c=!0:H(["@media (",x.join("touch-enabled),("),r,")","{#modernizr{top:9px;position:absolute}}"].join(""),function(a){c=9===a.offsetTop}),c},C.geolocation=function(){return"geolocation"in navigator},C.postmessage=function(){return!!a.postMessage},C.websqldatabase=function(){return!!a.openDatabase},C.indexedDB=function(){return!!j("indexedDB",a)},C.hashchange=function(){return J("hashchange",a)&&(b.documentMode===c||b.documentMode>7)},C.history=function(){return!!a.history&&!!history.pushState},C.draganddrop=function(){var a=b.createElement("div");return"draggable"in a||"ondragstart"in a&&"ondrop"in a},C.websockets=function(){return"WebSocket"in a||"MozWebSocket"in a},C.rgba=function(){return d("background-color:rgba(150,255,150,.5)"),g(t.backgroundColor,"rgba")},C.hsla=function(){return d("background-color:hsla(120,40%,100%,.5)"),g(t.backgroundColor,"rgba")||g(t.backgroundColor,"hsla")},C.multiplebgs=function(){return d("background:url(https://),url(https://),red url(https://)"),/(url\s*\(.*?){3}/.test(t.background)},C.backgroundsize=function(){return j("backgroundSize")},C.borderimage=function(){return j("borderImage")},C.borderradius=function(){return j("borderRadius")},C.boxshadow=function(){return j("boxShadow")},C.textshadow=function(){return""===b.createElement("div").style.textShadow},C.opacity=function(){return e("opacity:.55"),/^0.55$/.test(t.opacity)},C.cssanimations=function(){return j("animationName")},C.csscolumns=function(){return j("columnCount")},C.cssgradients=function(){var a="background-image:",b="gradient(linear,left top,right bottom,from(#9f9),to(white));",c="linear-gradient(left top,#9f9, white);";return d((a+"-webkit- ".split(" ").join(b+a)+x.join(c+a)).slice(0,-a.length)),g(t.backgroundImage,"gradient")},C.cssreflections=function(){return j("boxReflect")},C.csstransforms=function(){return!!j("transform")},C.csstransforms3d=function(){var a=!!j("perspective");return a&&"webkitPerspective"in q.style&&H("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}",function(b,c){a=9===b.offsetLeft&&3===b.offsetHeight}),a},C.csstransitions=function(){return j("transition")},C.fontface=function(){var a;return H('@font-face {font-family:"font";src:url("https://")}',function(c,d){var e=b.getElementById("smodernizr"),f=e.sheet||e.styleSheet,g=f?f.cssRules&&f.cssRules[0]?f.cssRules[0].cssText:f.cssText||"":"";a=/src/i.test(g)&&0===g.indexOf(d.split(" ")[0])}),a},C.generatedcontent=function(){var a;return H(['#modernizr:after{content:"',v,'";visibility:hidden}'].join(""),function(b){a=b.offsetHeight>=1}),a},C.video=function(){var a=b.createElement("video"),c=!1;try{(c=!!a.canPlayType)&&(c=new Boolean(c),c.ogg=a.canPlayType('video/ogg; codecs="theora"').replace(/^no$/,""),c.h264=a.canPlayType('video/mp4; codecs="avc1.42E01E"').replace(/^no$/,""),c.webm=a.canPlayType('video/webm; codecs="vp8, vorbis"').replace(/^no$/,""))}catch(d){}return c},C.audio=function(){var a=b.createElement("audio"),c=!1;try{(c=!!a.canPlayType)&&(c=new Boolean(c),c.ogg=a.canPlayType('audio/ogg; codecs="vorbis"').replace(/^no$/,""),c.mp3=a.canPlayType("audio/mpeg;").replace(/^no$/,""),c.wav=a.canPlayType('audio/wav; codecs="1"').replace(/^no$/,""),c.m4a=(a.canPlayType("audio/x-m4a;")||a.canPlayType("audio/aac;")).replace(/^no$/,""))}catch(d){}return c},C.localstorage=function(){try{return localStorage.setItem(r,r),localStorage.removeItem(r),!0}catch(a){return!1}},C.sessionstorage=function(){try{return sessionStorage.setItem(r,r),sessionStorage.removeItem(r),!0}catch(a){return!1}},C.webworkers=function(){return!!a.Worker},C.applicationcache=function(){return!!a.applicationCache},C.svg=function(){return!!b.createElementNS&&!!b.createElementNS(B.svg,"svg").createSVGRect},C.inlinesvg=function(){var a=b.createElement("div");return a.innerHTML="<svg/>",(a.firstChild&&a.firstChild.namespaceURI)==B.svg},C.smil=function(){return!!b.createElementNS&&/SVGAnimate/.test(w.call(b.createElementNS(B.svg,"animate")))},C.svgclippaths=function(){return!!b.createElementNS&&/SVGClipPath/.test(w.call(b.createElementNS(B.svg,"clipPath")))};for(var L in C)m(C,L)&&(l=L.toLowerCase(),o[l]=C[L](),F.push((o[l]?"":"no-")+l));return o.input||k(),o.addTest=function(a,b){if("object"==typeof a)for(var d in a)m(a,d)&&o.addTest(d,a[d]);else{if(a=a.toLowerCase(),o[a]!==c)return o;b="function"==typeof b?b():b,p&&(q.className+=" "+(b?"":"no-")+a),o[a]=b}return o},d(""),s=u=null,function(a,b){function c(a,b){var c=a.createElement("p"),d=a.getElementsByTagName("head")[0]||a.documentElement;return c.innerHTML="x<style>"+b+"</style>",d.insertBefore(c.lastChild,d.firstChild)}function d(){var a=r.elements;return"string"==typeof a?a.split(" "):a}function e(a){var b=q[a[o]];return b||(b={},p++,a[o]=p,q[p]=b),b}function f(a,c,d){if(c||(c=b),k)return c.createElement(a);d||(d=e(c));var f;return f=d.cache[a]?d.cache[a].cloneNode():n.test(a)?(d.cache[a]=d.createElem(a)).cloneNode():d.createElem(a),f.canHaveChildren&&!m.test(a)?d.frag.appendChild(f):f}function g(a,c){if(a||(a=b),k)return a.createDocumentFragment();c=c||e(a);for(var f=c.frag.cloneNode(),g=0,h=d(),i=h.length;i>g;g++)f.createElement(h[g]);return f}function h(a,b){b.cache||(b.cache={},b.createElem=a.createElement,b.createFrag=a.createDocumentFragment,b.frag=b.createFrag()),a.createElement=function(c){return r.shivMethods?f(c,a,b):b.createElem(c)},a.createDocumentFragment=Function("h,f","return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&("+d().join().replace(/\w+/g,function(a){return b.createElem(a),b.frag.createElement(a),'c("'+a+'")'})+");return n}")(r,b.frag)}function i(a){a||(a=b);var d=e(a);return r.shivCSS&&!j&&!d.hasCSS&&(d.hasCSS=!!c(a,"article,aside,figcaption,figure,footer,header,hgroup,nav,section{display:block}mark{background:#FF0;color:#000}")),k||h(a,d),a}var j,k,l=a.html5||{},m=/^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i,n=/^<|^(?:a|b|button|code|div|fieldset|form|h1|h2|h3|h4|h5|h6|i|iframe|img|input|label|li|link|ol|option|p|param|q|script|select|span|strong|style|table|tbody|td|textarea|tfoot|th|thead|tr|ul)$/i,o="_html5shiv",p=0,q={};!function(){try{var a=b.createElement("a");a.innerHTML="<xyz></xyz>",j="hidden"in a,k=1==a.childNodes.length||function(){b.createElement("a");var a=b.createDocumentFragment();return"undefined"==typeof a.cloneNode||"undefined"==typeof a.createDocumentFragment||"undefined"==typeof a.createElement}()}catch(c){j=!0,k=!0}}();var r={elements:l.elements||"abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video",shivCSS:l.shivCSS!==!1,supportsUnknownElements:k,shivMethods:l.shivMethods!==!1,type:"default",shivDocument:i,createElement:f,createDocumentFragment:g};a.html5=r,i(b)}(this,b),o._version=n,o._prefixes=x,o._domPrefixes=A,o._cssomPrefixes=z,o.mq=I,o.hasEvent=J,o.testProp=function(a){return h([a])},o.testAllProps=j,o.testStyles=H,o.prefixed=function(a,b,c){return b?j(a,b,c):j(a,"pfx")},q.className=q.className.replace(/(^|\s)no-js(\s|$)/,"$1$2")+(p?" js "+F.join(" "):""),o}(this,this.document),function(a,b,c){function d(a){return"[object Function]"==q.call(a)}function e(a){return"string"==typeof a}function f(){}function g(a){return!a||"loaded"==a||"complete"==a||"uninitialized"==a}function h(){var a=r.shift();s=1,a?a.t?o(function(){("c"==a.t?m.injectCss:m.injectJs)(a.s,0,a.a,a.x,a.e,1)},0):(a(),h()):s=0}function i(a,c,d,e,f,i,j){function k(b){if(!n&&g(l.readyState)&&(t.r=n=1,!s&&h(),l.onload=l.onreadystatechange=null,b)){"img"!=a&&o(function(){v.removeChild(l)},50);for(var d in A[c])A[c].hasOwnProperty(d)&&A[c][d].onload()}}var j=j||m.errorTimeout,l={},n=0,q=0,t={t:d,s:c,e:f,a:i,x:j};1===A[c]&&(q=1,A[c]=[],l=b.createElement(a)),"object"==a?l.data=c:(l.src=c,l.type=a),l.width=l.height="0",l.onerror=l.onload=l.onreadystatechange=function(){k.call(this,q)},r.splice(e,0,t),"img"!=a&&(q||2===A[c]?(v.insertBefore(l,u?null:p),o(k,j)):A[c].push(l))}function j(a,b,c,d,f){return s=0,b=b||"j",e(a)?i("c"==b?x:w,a,b,this.i++,c,d,f):(r.splice(this.i++,0,a),1==r.length&&h()),this}function k(){var a=m;return a.loader={load:j,i:0},a}var l,m,n=b.documentElement,o=a.setTimeout,p=b.getElementsByTagName("script")[0],q={}.toString,r=[],s=0,t="MozAppearance"in n.style,u=t&&!!b.createRange().compareNode,v=u?n:p.parentNode,n=a.opera&&"[object Opera]"==q.call(a.opera),n=!!b.attachEvent&&!n,w=t?"object":n?"script":"img",x=n?"script":w,y=Array.isArray||function(a){return"[object Array]"==q.call(a)},z=[],A={},B={timeout:function(a,b){return b.length&&(a.timeout=b[0]),a}};m=function(a){function b(a){var b,c,d,a=a.split("!"),e=z.length,f=a.pop(),g=a.length,f={url:f,origUrl:f,prefixes:a};for(c=0;g>c;c++)d=a[c].split("="),(b=B[d.shift()])&&(f=b(f,d));for(c=0;e>c;c++)f=z[c](f);return f}function g(a,e,f,g,i){var j=b(a),l=j.autoCallback;j.url.split(".").pop().split("?").shift(),j.bypass||(e&&(e=d(e)?e:e[a]||e[g]||e[a.split("/").pop().split("?")[0]]||h),j.instead?j.instead(a,e,f,g,i):(A[j.url]?j.noexec=!0:A[j.url]=1,f.load(j.url,j.forceCSS||!j.forceJS&&"css"==j.url.split(".").pop().split("?").shift()?"c":c,j.noexec,j.attrs,j.timeout),(d(e)||d(l))&&f.load(function(){k(),e&&e(j.origUrl,i,g),l&&l(j.origUrl,i,g),A[j.url]=2})))}function i(a,b){function c(a,c){if(a){if(e(a))c||(l=function(){var a=[].slice.call(arguments);m.apply(this,a),n()}),g(a,l,b,0,j);else if(Object(a)===a)for(i in h=function(){var b,c=0;for(b in a)a.hasOwnProperty(b)&&c++;return c}(),a)a.hasOwnProperty(i)&&(!c&&!--h&&(d(l)?l=function(){var a=[].slice.call(arguments);m.apply(this,a),n()}:l[i]=function(a){return function(){var b=[].slice.call(arguments);a&&a.apply(this,b),n()}}(m[i])),g(a[i],l,b,i,j))}else!c&&n()}var h,i,j=!!a.test,k=a.load||a.both,l=a.callback||f,m=l,n=a.complete||f;c(j?a.yep:a.nope,!!k),k&&c(k)}var j,l,n=this.yepnope.loader;if(e(a))g(a,0,n,0);else if(y(a))for(j=0;j<a.length;j++)l=a[j],e(l)?g(l,0,n,0):y(l)?m(l):Object(l)===l&&i(l,n);else Object(a)===a&&i(a,n)},m.addPrefix=function(a,b){B[a]=b},m.addFilter=function(a){z.push(a)},m.errorTimeout=1e4,null==b.readyState&&b.addEventListener&&(b.readyState="loading",b.addEventListener("DOMContentLoaded",l=function(){b.removeEventListener("DOMContentLoaded",l,0),b.readyState="complete"},0)),a.yepnope=k(),a.yepnope.executeStack=h,a.yepnope.injectJs=function(a,c,d,e,i,j){var k,l,n=b.createElement("script"),e=e||m.errorTimeout;n.src=a;for(l in d)n.setAttribute(l,d[l]);c=j?h:c||f,n.onreadystatechange=n.onload=function(){!k&&g(n.readyState)&&(k=1,c(),n.onload=n.onreadystatechange=null)},o(function(){k||(k=1,c(1))},e),i?n.onload():p.parentNode.insertBefore(n,p)},a.yepnope.injectCss=function(a,c,d,e,g,i){var j,e=b.createElement("link"),c=i?h:c||f;e.href=a,e.rel="stylesheet",e.type="text/css";for(j in d)e.setAttribute(j,d[j]);g||(p.parentNode.insertBefore(e,p),o(c,0))}}(this,document),Modernizr.load=function(){yepnope.apply(window,[].slice.call(arguments,0))},function(a){a.fn.flowtype=function(b){var c=a.extend({maximum:9999,minimum:1,maxFont:9999,minFont:1,fontRatio:35},b),d=function(b){var d=a(b),e=d.width(),f=e>c.maximum?c.maximum:e<c.minimum?c.minimum:e,g=f/c.fontRatio,h=g>c.maxFont?c.maxFont:g<c.minFont?c.minFont:g;d.css("font-size",h+"px")};return this.each(function(){var b=this;a(window).resize(function(){d(b)}),d(this)})}}(jQuery),function(){var a=navigator.userAgent.toLowerCase().indexOf("webkit")>-1,b=navigator.userAgent.toLowerCase().indexOf("opera")>-1,c=navigator.userAgent.toLowerCase().indexOf("msie")>-1;(a||b||c)&&document.getElementById&&window.addEventListener&&window.addEventListener("hashchange",function(){var a=document.getElementById(location.hash.substring(1));a&&(/^(?:a|select|input|button|textarea)$/i.test(a.tagName)||(a.tabIndex=-1),a.focus())},!1)}();var ie=isIE(),mobile=/webos|iphone|ipod|blackberry|iemobile|opera mini/i.test(navigator.userAgent.toLowerCase()),mobileSized=!1,ipad=/ipad/i.test(navigator.userAgent.toLowerCase()),Project=function(a,b,c,d){function e(){function a(a,c,d,h){a[e](g+c,"wheel"==f?d:function(a){!a&&(a=b.event);var c={originalEvent:a,target:a.target||a.srcElement,type:"wheel",deltaMode:"MozMousePixelScroll"==a.type?0:1,deltaX:0,deltaZ:0,preventDefault:function(){a.preventDefault?a.preventDefault():a.returnValue=!1}};return"mousewheel"==f?(c.deltaY=-1/40*a.wheelDelta,a.wheelDeltaX&&(c.deltaX=-1/40*a.wheelDeltaX)):c.deltaY=a.detail,d(c)},h||!1)}var e,f,g="";b.addEventListener?e="addEventListener":(e="attachEvent",g="on"),f="onwheel"in c.createElement("div")?"wheel":c.onmousewheel!==d?"mousewheel":"DOMMouseScroll",b.addWheelListener=function(b,c,d){a(b,f,c,d),"DOMMouseScroll"==f&&a(b,"MozMousePixelScroll",c,d)}}function f(){}function g(a){1!=i&&(i=!0,a>0?f.moveDown():0>a&&f.moveUp(),setTimeout(function(){i=!1},2e3))}function h(){a(b).on("orientationchange",function(c){var d,e=a("section"),f=e.length;if(parseInt(a("#wrapper").css("top"))<0){var g=a("section.active").index();a("#wrapper").css({top:-(g*a(b).height())})}for(var h=0;f>h;h++){d=a("section").eq(h);var i=h*a(b).outerHeight();"footer"==d.attr("id")&&(i=i-a(b).outerHeight()+d.outerHeight(!0)),d.find("> .data-top").html(i),d.hasClass("active")&&a("#wrapper").css({top:-d.find("> .data-top").html()}),d.hasClass("div-overflow")&&d.removeClass("div-overflow"),d.hasClass("horisontal-scroll"),d.find(".container").length>1?d.find(".container").each(function(){a(this).outerHeight()>a(b).height()&&d.addClass("div-overflow")}):d.find(".container").outerHeight()>a(b).height()&&d.addClass("div-overflow")}}),0==mobile&&a("#wrapper").width()>767&&0==ipad&&a(b).resize(function(){var c,d=a("section"),e=d.length;if(parseInt(a("#wrapper").css("top"))<0){a("section.active").index()}for(var f=0;e>f;f++){c=a("section").eq(f);var g=f*a(b).outerHeight();"footer"==c.attr("id")&&(g=g-a(b).outerHeight()+c.outerHeight(!0)),c.find(".data-top").html(g),c.find(".wrap").css({height:c.outerHeight(!0)}),c.hasClass("active")&&a("#wrapper").css({top:-c.find("> .data-top").html()}),c.hasClass("div-overflow")&&c.removeClass("div-overflow"),c.hasClass("horisontal-scroll"),c.find(".container").length>1?c.find(".container").each(function(){a(this).outerHeight()>a(b).height()&&c.addClass("div-overflow")}):c.find(".container").outerHeight()>a(b).height()&&c.addClass("div-overflow")}})}var i=!1;return f.moveDown=function(){var c=(a("section"),a("section.active")),d=c.index()+1,e=a("#wrapper"),f=a("#side-nav");0!=c.next("section").length&&(f.find("li.active").removeClass("active"),f.find("li").eq(d).addClass("active"),c.next("section").addClass("active").find(".holder").first().addClass("active"),c.removeClass("active").find(".holder.active").removeClass("active"),e.css({top:-c.next("section").find("> .data-top").html()}),a(b).scrollTop(c.next("section").find("> .data-top").html()))},f.moveUp=function(){var c=(a("section"),a("section.active")),d=c.index()-1,e=a("#wrapper"),f=(parseInt(e.css("top")),a("#side-nav"));0!=c.prev("section").length&&(f.find("li.active").removeClass("active"),f.find("li").eq(d).addClass("active"),c.prev("section").addClass("active").find(".holder").first().addClass("active"),c.removeClass("active").find(".holder.active").removeClass("active"),e.css({top:-c.prev("section").find("> .data-top").html()}),a(b).scrollTop(c.prev("section").find("> .data-top").html()))},{init:function(){var d,j=a("section"),k=j.length;a("[data-clone]").each(function(){var b=a(this).data("clone");a(this).children().clone().appendTo(b)}),a('li > a[href="'+b.location.pathname+'"]:parent').parent().addClass("current-menu-item"),a("img.mobile-featured-image").each(function(){var b=a(this),c=b.data("mobile-src"),d=b.data("src");1==mobile&&a("#wrapper").width()<768?b.attr({src:c}):b.attr({src:d})}),a("body").flowtype({minFont:12,maxFont:60}),h(),j.first().addClass("start active").find(".holder").addClass("active");for(var l=0;k>l;l++){d=a("section").eq(l);var m=l*a(b).outerHeight();l==k-1&&(m=m-a(b).outerHeight()+d.outerHeight(!0),d.find(".wrap").css({height:d.outerHeight(!0)})),a('<span class="data-top">'+m+"</span>").appendTo(d);var n=a("<li><span></span><div><p>"+d.find(".page-title").html()+"</p></div></li>");a("#side-nav ul").append(n),d.find(".holder").length>1&&d.addClass("horisontal-scroll")}a("#side-nav li:first").addClass("active"),Helpers.LoadImages(a("body"),function(){var c,d,e=a("section");e.each(function(){c=a(this),0==mobile&&a("#wrapper").width()>767?c.find(".holder").length>1&&(c.find(".holder").each(function(){d=a(this).find(".container").outerHeight(),a('<span class="data-top">'+d+"</span>").appendTo(a(this))}),c.find(".wrap").css({height:c.find(".holder").first().find(".data-top").html()})):c.find(".holder").length>1&&(c.find(".holder").each(function(){d=a(this).outerHeight(),a('<span class="data-top">'+d+"</span>").appendTo(a(this))}),c.find(".wrap").css({height:c.find(".holder").first().find(".data-top").html()})),c.find(".container").length>1?c.find(".container").each(function(){a(this).outerHeight()>a(b).height()&&c.addClass("div-overflow")}):c.find(".container").outerHeight()>a(b).height()&&c.addClass("div-overflow")})});var o=!1;if(0==mobile&&a("#wrapper").width()>767){if(e(),addWheelListener(c,function(c){if(1==i)return g(c.deltaY),void c.preventDefault();if(c.deltaY>0){if(1==i)return;if(a("section.active").hasClass("div-overflow")){if(a("section.active").scrollTop()+a(b).height()<a("section.active .holder.active .container").outerHeight())return void(o=!0);1==o&&(i=!0,setTimeout(function(){i=!1,o=!1},800))}}else if(c.deltaY<0&&a("section.active").hasClass("div-overflow")){if(a("section.active").scrollTop()>0)return void(o=!0);1==o&&(i=!0,setTimeout(function(){i=!1,o=!1},800))}g(c.deltaY),c.preventDefault()}),a("#side-nav").css({"margin-top":-(a("#side-nav").height()/2)}),a(".sidenav-header").css({"margin-top":-(a("#side-nav").height()+50)}),a(".button.scroll").off("click").on("click",function(){var c=a(this);return"footer"==c.closest("section").attr("id")?(a("#side-nav").find("li.active").removeClass("active"),a("#side-nav").find("li:eq(0)").addClass("active"),a("section.active").removeClass("active"),a("section:eq(0)").addClass("active"),a("#wrapper").css({top:0}),void a(b).scrollTop(0)):(f.moveDown(),void(1==ipad&&a("#side-nav li.open").length>0&&a("#side-nav li.open").removeClass("open")))}),a(".button.horisontal").off("click").on("click",function(){var b=a(this),c=b.closest("section");c.find(".holder.active").removeClass("active"),c.animate({scrollTop:0}),b.hasClass("left")?(c.removeClass("scrolled-right"),c.find(".holder:first").addClass("active"),c.find(".wrap").css({height:c.find(".holder").first().find(".data-top").html()})):b.hasClass("right")&&(c.addClass("scrolled-right"),c.find(".holder:last").addClass("active"),c.find(".wrap").css({height:c.find(".holder").last().find(".data-top").html()})),1==ipad&&a("#side-nav li.open").length>0&&a("#side-nav li.open").removeClass("open")}),a(".no-touch #side-nav li").mouseenter(function(){a(this).siblings("li").hasClass("no-show")||a(this).parent().find("li").addClass("no-show")}),a(".no-touch #side-nav li").off("click").on("click",function(){var c=a(this);c.siblings(".active").removeClass("active"),c.addClass("active"),j.siblings("section").removeClass("active"),c.index()==c.closest("ul").find("li").length-1?(j.eq(c.index()).addClass("active"),a("#wrapper").css({top:-(a(b).height()*(c.index()-1)+j.eq(c.index()).outerHeight(!0))}),a(b).scrollTop(a(b).height()*(c.index()-1)+j.eq(c.index()).outerHeight(!0))):(j.eq(c.index()).addClass("active"),a("#wrapper").css({top:-a(b).height()*c.index()}),a(b).scrollTop(a(b).height()*c.index()))}),a(".touch #side-nav li").off("click").on("click",function(){a(this).siblings("li").hasClass("no-show")||a(this).parent().find("li").addClass("no-show");var c=a(this);c.hasClass("open")?(c.siblings(".active").removeClass("active"),c.addClass("active"),c.removeClass("open"),j.siblings("section").removeClass("active"),c.index()==c.closest("ul").find("li").length-1?(j.eq(c.index()).addClass("active"),a("#wrapper").css({top:-(a(b).height()*(c.index()-1)+j.eq(c.index()).outerHeight(!0))}),a(b).scrollTop(a(b).height()*(c.index()-1)+j.eq(c.index()).outerHeight(!0))):(j.eq(c.index()).addClass("active"),a("#wrapper").css({top:-a(b).height()*c.index()}),a(b).scrollTop(a(b).height()*c.index()))):(c.addClass("open"),c.siblings(".open").removeClass("open"))}),a("section.blackandwhite").length>0)var p=a("section.blackandwhite").index();if(a("section.questions").length>0){var p=a("section.questions").index();a("#side-nav li").eq(p).addClass("faq")}}else{a("#header nav").css({height:a(b).height()-a("#header").height()});var q=0;a("#mobile-nav").off("click").on("click",function(){a("#header nav").hasClass("open")?(a("#header nav").removeClass("open").slideUp(),a("#wrapper").css({position:"static",top:0}),a(b).scrollTop(q),a(this).removeClass("open")):(a("#header nav").addClass("open").slideDown(),q=a(b).scrollTop(),a("#wrapper").css({position:"fixed",top:-q}),a(this).addClass("open"))}),a("#header nav li a").off("click").on("click",function(a){return}),a(".button.scroll").off("click").on("click",function(){var b=a(this);return"footer"==b.closest("section").attr("id")?void a("body").animate({scrollTop:0}):void a("body").animate({scrollTop:b.closest("section").next().offset().top})}),a(".button.horisontal").off("click").on("click",function(){var b=a(this),c=b.closest("section");b.hasClass("left")?(c.removeClass("scrolled-right"),c.find(".wrap").css({height:c.find(".holder").first().find(".data-top").html()}),a("body").animate({scrollTop:c.offset().top})):b.hasClass("right")&&(c.addClass("scrolled-right"),c.find(".wrap").css({height:c.find(".holder").last().find(".data-top").html()}),a("body").animate({scrollTop:c.offset().top}))})}a(".questions li h3").off("click").on("click",function(b){var c=a(this),d=c.closest("li");d.hasClass("active")?(d.removeClass("active"),d.find("p").slideUp(200)):(d.siblings(".active").removeClass("active").find("p").slideUp(200),d.addClass("active"),d.find("p").slideDown(200))})}}}(jQuery,window,document);$(function(){Project.init()});var Helpers=function(a){return{transEndEventNames:{WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd",msTransition:"msTransitionEnd",transition:"transitionEnd"},Transition:function(b,c,d,e,f){d=d||500;var g=[];b instanceof Array?g=b:"string"==typeof b?g.push(a(b)):g.push(b);for(var h=0;h<g.length;h++)g[h].stop().animate(c,{duration:d,easing:e});setTimeout(function(){a.isFunction(f)&&f()},d)},ElementInView:function(b){var b,c,d,e=Paralax.WindowSize().scrollTop,f=Paralax.WindowSize().scrollTop+(Paralax.WindowSize().height-.1*Paralax.WindowSize().height);e+Paralax.WindowSize().height;if(c=b.offset().top,d=c+b.height(),0!=c&&0!=d){if(f>=c)return!0;if(e+Paralax.WindowSize().height>a(document).height()-100)return!0}return!1},Alert:function(a,b){},LoadImage:function(a,b,c){var d=new Image;return d.src=b,d.naturalWidth>0?void c(a):void(d.onload=function(){c(a)})},LoadBackgroundImage:function(a,b,c){function d(){h++,h==a.length&&c(a)}for(var e=0;e<a.length;e++){if(b[e].indexOf(!1)){var f=b[e].replace("url(","");f=f.replace(")","")}else f=b;var g=new Image;g.onload=d,g.onerror=d,g.src=f}var h=0},LoadImages:function(b,c){var d,e,f=b.find("img[src]:not(data-preload),img[data-preload]:not(src)"),g=0;0==f.length&&a.isFunction(c)&&c(),f.each(function(b,h){d=a(h),void 0!=d&&(e=d.attr("data-preload")?d.data("preload"):d.attr("src"),Helpers.LoadImage(a(h),e,function(b){b.attr("data-preload")&&(b.removeAttr("data-preload"),Helpers.Transition(b,{opacity:1},1e3,"easeInOutCirc")),g++,f.length===g&&a.isFunction(c)&&c()}))})},OverlaySimple:function(b,c,d){var e;if(c){var f=b.height()>Paralax.WindowSize().height?b.height():Paralax.WindowSize().height,g={};g[Modernizr.prefixed("transition")]="opacity 450ms cubic-bezier(0.165, 0.84, 0.44, 1)",g.opacity=0,g.height=f,e=a('<div class="content-overlay"></div>').css(g).prependTo(b),e.off("click").on("click",d),e.timer=setTimeout(function(){e.css("opacity",.7)},1)}else{e=b.find(".content-overlay").css({opacity:0});try{clearTimeout(e.timer)}catch(h){}e.timer=setTimeout(function(){e.remove()},450)}},Overlay:function(b,c,d,e,f,g){var h;if(c){var i=b.height()>Paralax.WindowSize().height?b.height():Paralax.WindowSize().height,j={};if(b.is("body")&&(j.position="fixed",j.zIndex=8e4),j[Modernizr.prefixed("transition")]="opacity 450ms cubic-bezier(0.165, 0.84, 0.44, 1)",j.opacity=0,0==d&&(j.opacity=1),j.height=i,h=(b.find(".content-overlay").lenght>0?b.find(".content-overlay"):a('<div class="content-overlay"></div>')).css(j).prependTo(b),h.off("click").on("click",g),0==d)return void(a.isFunction(f)&&f());h.timer=setTimeout(function(){h.css("opacity",e),h.timer=setTimeout(function(){a.isFunction(f)&&f()},450)},d)}else h=b.find(".content-overlay").css({opacity:0}),h.timer=setTimeout(function(){try{clearTimeout(h.timer)}catch(b){}h.timer=setTimeout(function(){h.remove(),a.isFunction(f)&&f()},450)},d)},ScrollToPosition:function(b,c,d){a(document).height()-Paralax.WindowSize().height<b&&(b=a(document).height()-Paralax.WindowSize().height),a("html, body").addClass("scrolling").stop().animate({scrollTop:b},500,"easeInOutExpo",function(){a("html, body").removeClass("scrolling"),a(window).off("mousewheel"),a.isFunction(c)&&c()}),a(window).off("mousewheel").on("mousewheel",function(){a("html, body").stop().removeClass("scrolling"),a(window).off("mousewheel"),a.isFunction(c)&&c()})},OnDomLoaded:function(a){function b(){c||(c=!0,a())}var c=!1;if(document.addEventListener)document.addEventListener("DOMContentLoaded",b,!1);else if(document.attachEvent){try{var d=null!=window.frameElement}catch(e){}if(document.documentElement.doScroll&&!d){var f=function(){if(!c)try{document.documentElement.doScroll("left"),b()}catch(a){setTimeout(f,10)}};f()}document.attachEvent("onreadystatechange",function(){"complete"===document.readyState&&b()})}if(window.addEventListener)window.addEventListener("load",b,!1);else if(window.attachEvent)window.attachEvent("onload",b);else{var g=window.onload;window.onload=function(){g&&g(),b()}}}}}(jQuery);